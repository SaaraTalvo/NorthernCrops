    ...
    if ( !empty($_POST)) {
      ...
      /*  else if ( !filter_var($email,FILTER_VALIDATE_EMAIL) ) {
        ...
        if (empty($kasvuvyohyke)) {
            $kasvuvyohykeError = 'Syötä kasvuvyohykenumero';
            $valid = false;
        }
    ...
    <div class="container">
      <div class="card bg-light">
                    <div class="card-header">
                        <h4>Lisää uusi käyttajä</h4>
                    </div>
             
                    <div class="body my-3 px-3">
                        <form class="form-horizontal" action="lisaa_kayttaja.php" method="post" enctype="multipart/form-data">
